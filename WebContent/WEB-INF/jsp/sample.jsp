...
<div class="span10">
	...
	<div class="container-fluid"><!-- information-->
		<div class="well well-large">
			<s:form action="selectSample!selectData" cssClass="form-search" cssStyle="padding: 0px 5px" >
				...
				<s:submit id="search" value="Search" cssClass="btn btn-primary"  action="selectSample" method="selectData" />
			</s:form>
		</div>
	</div><!-- /information-->
